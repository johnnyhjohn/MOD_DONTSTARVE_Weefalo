...
local assets =
{
    Asset("ANIM",  "anim/summonstonechop.zip"),
    ------------------------------------------
    Asset("ATLAS", "images/map_icons/runes/summonstonechop_map.xml"),
    Asset("IMAGE", "images/map_icons/runes/summonstonechop_map.tex"),
    ------------------------------------------
...
local function fn(Sim)
    ...
    ------------------------------------------
    inst:AddTag("summonstonechop")
    inst:AddTag("summonstone")
    ------------------------------------------
    inst.MiniMapEntity:SetIcon("summonstonechop_map.tex")
    ...
    inst.AnimState:SetBuild("summonstonechop")
    ...
    inst.components.inventoryitem.imagename = "summonstonechop"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/runes/summonstonechop.xml"
    ------------------------------------------
    return inst
end 

return Prefab( "common/inventory/summonstonechop", fn, assets)  