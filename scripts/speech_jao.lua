...
return {
	...
	BATTLECRY =
	{
		...
		PREY = "Die asshole!",
		SPIDER = "Chibata!",
		SPIDER_WARRIOR = "Meet my golem ... and die!",
	},
	COMBAT_QUIT =
	{
	...
	DESCRIBE =
	{
		...
		BEARDHAIR = "I made them with my fjao.",
		...
		BEEFALO =
		{
			FOLLOWER = "He's coming along pejaofully.",
		...
		TELEPORTATO_BASE =
		{
			ACTIVE = "With this I can surely pass through spjao and time!",
		...
		WALL_MOONROCK = "Spjaoy and smooth!",
